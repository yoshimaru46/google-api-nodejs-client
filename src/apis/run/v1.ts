...
export namespace run_v1 {
  ...
  export class Resource$Namespaces$Executions {
     ...
     *     name: 'namespaces/my-namespace/executions/my-execution',
     *     // Optional. Specifies the propagation policy of delete. Cloud Run currently ignores this setting, and deletes in the background. Please see http://kubernetes.io/docs/concepts/workloads/controllers/garbage-collection/ for more information.
     *     propagationPolicy: 'placeholder-value',
     *   });
     *   console.log(res.data);
     *
  ...
  export class Resource$Namespaces$Services {
     ...
     *     // Indicates that the server should validate the request and populate default values without persisting the request. Supported values: `all`
     *     dryRun: 'placeholder-value',
     *     // The resource's parent. In Cloud Run, it may be one of the following: * `namespaces/{project_id_or_number\}` * `projects/{project_id_or_number\}/locations/{region\}` * `projects/{project_id_or_number\}/regions/{region\}`
     *     parent: 'namespaces/my-namespace',
     *
     *     // Request body metadata
     *     requestBody: {
     ...
     *     // Not supported, and ignored by Cloud Run.
     *     kind: 'placeholder-value',
     *     // The fully qualified name of the service to delete. It can be any of the following forms: * `namespaces/{project_id_or_number\}/services/{service_name\}` * `projects/{project_id_or_number\}/locations/{region\}/services/{service_name\}` * `projects/{project_id_or_number\}/regions/{region\}/services/{service_name\}`
     ...
     *     // The fully qualified name of the service to retrieve. It can be any of the following forms: * `namespaces/{project_id_or_number\}/services/{service_name\}` * `projects/{project_id_or_number\}/locations/{region\}/services/{service_name\}` * `projects/{project_id_or_number\}/regions/{region\}/services/{service_name\}`
     *     name: 'namespaces/my-namespace/services/my-service',
     *   });
     *   console.log(res.data);
     *
     ...
     *     // Optional. The maximum number of records that should be returned.
     *     limit: 'placeholder-value',
     *     // The parent from where the resources should be listed. In Cloud Run, it may be one of the following: * `namespaces/{project_id_or_number\}` * `projects/{project_id_or_number\}/locations/{region\}` * `projects/{project_id_or_number\}/regions/{region\}`
     *     parent: 'namespaces/my-namespace',
     *     // Not supported, and ignored by Cloud Run.
     *     resourceVersion: 'placeholder-value',
     *     // Not supported, and ignored by Cloud Run.
     ...
     *     // Indicates that the server should validate the request and populate default values without persisting the request. Supported values: `all`
     *     dryRun: 'placeholder-value',
     *     // The fully qualified name of the service to replace. It can be any of the following forms: * `namespaces/{project_id_or_number\}/services/{service_name\}` * `projects/{project_id_or_number\}/locations/{region\}/services/{service_name\}` * `projects/{project_id_or_number\}/regions/{region\}/services/{service_name\}`
     *     name: 'namespaces/my-namespace/services/my-service',
     *
     *     // Request body metadata
     *     requestBody: {
